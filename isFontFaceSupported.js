...
/*!
 * isFontFaceSupported - v0.3 - 8/20/2009
 * 
...
function isFontFaceSupported(){
  ...
  doc.body.removeChild(st);
  doc.body.removeChild(spn);
  //console.log(wid,nwid);
  return wid !== nwid;
}